    ...
    return (
        <>
            <section className='w-full h-screen flex'>
                <div className={`absolute bg-white h-screen md:static z-20 w-[250px] transition-all duration-300 ease-in-out ${toggleMenu ? 'translate-x-0 border-r shadow-xl' : '-translate-x-[250px] md:translate-x-0'} py-4 px-3 border-gray-300 md:border-r md:shadow-xl`}>
